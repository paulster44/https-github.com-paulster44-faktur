    ...
    return (
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg">
            <div className="p-4 md:p-6 border-b border-slate-200 dark:border-slate-700">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">Manage your company profile and branding.</p>
            </div>
            <form onSubmit={handleSubmit}>
                <div className="p-4 md:p-6 space-y-8">
                        ...
                        <h3 className="text-lg font-medium text-slate-900 dark:text-white">Company Logo</h3>
                         <div className="mt-2 flex items-center space-x-6">
                            <div className="shrink-0">
                                {profile.logo ? (
                                    <img className="h-20 w-20 object-contain rounded-md bg-slate-100 dark:bg-slate-700 p-1" src={profile.logo} alt="Company Logo" />
                                ) : (
                    ...
                    <div className="space-y-4">
                        <h3 className="text-lg font-medium text-slate-900 dark:text-white">Company Details</h3>
                        <div>
                    ...
                    <div className="pt-2 space-y-4">
                         <h3 className="text-lg font-medium text-slate-900 dark:text-white">Company Address</h3>
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {/* Invoice Numbering */}
                    <div className="pt-2 space-y-4">
                         <h3 className="text-lg font-medium text-slate-900 dark:text-white">Invoice Numbering</h3>
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                    ...
                    {/* Tax Information */}
                    <div className="pt-2 space-y-4">
                         <h3 className="text-lg font-medium text-slate-900 dark:text-white">Tax Information</h3>
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">Tax Type</label>
                                <input type="text" name="taxType" value={profile.taxType} onChange={handleChange} placeholder="e.g., GST/HST Number" className="mt-1 block w-full rounded-md border-slate-300 dark:border-slate-600 shadow-sm focus:border-sky-500 focus:ring-sky-500 sm:text-sm bg-white dark:bg-slate-700" />
                            </div>
                            <div>
                 ...
                 <div className="px-6 py-4 bg-slate-50 dark:bg-slate-800/50 flex justify-end rounded-b-lg">
                    <button type="submit" className="px-4 py-2 text-sm font-medium text-white bg-sky-600 border border-transparent rounded-md shadow-sm hover:bg-sky-700">Save Changes</button>
                </div>
            </form>
        </div>
    );
